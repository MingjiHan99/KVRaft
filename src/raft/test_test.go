...
func TestRejoin2B(t *testing.T) {
	...
	leader1 := cfg.checkOneLeader()
	//log.Printf("CFGLEADER 1: %v", leader1)
	cfg.disconnect(leader1)
	...
	leader2 := cfg.checkOneLeader()
//	log.Printf("CFGLEADER 2: %v", leader2)
	cfg.disconnect(leader2)
...
func TestBackup2B(t *testing.T) {
	...
	//log.Printf("Group 1: %v %v %v", (leader1 + 2) % servers, (leader1 + 3) % servers, (leader1 + 4) % servers)
	
	//log.Printf("Partition agreement successed.")
	...
	time.Sleep(RaftElectionTimeout / 2)
//	log.Printf("Partition agreement 2 successed.")
	...
	cfg.connect(other)
//	log.Printf("Group 2: %v %v %v", (leader1 + 0) % servers, (leader1 + 1) % servers, other)
	// lots of successful commands to new group.
	for i := 0; i < 50; i++ {
		cfg.one(rand.Int(), 3, true)
	}
//	log.Printf("Partition agreement 3 successed.")
